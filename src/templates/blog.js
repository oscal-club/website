            ...
            <div className="border-top-1 border-accent-cool-darker padding-top-2 margin-bottom-4 usa-prose">
              ...
              <ul className="usa-list usa-list--unstyled padding-top-2">
                <li className="padding-bottom-1">
                  ...
                  <a className="usa-link" href="https://twitter.com/oscal_club">
                    @oscal-club on Twitter
                  </a>
                </li>
                <li className="padding-bottom-1">
                  <svg
                  ...
                  <a className="usa-link" href="https://github.com/oscal-club">
                    Github
                  </a>
                </li>
                <li className="padding-bottom-1">
                  ...
                  <a className="usa-link" href="/rss.xml">
                    RSS Feed
                  </a>
                </li>
              </ul>
